-- Converted from Spring's old hyprland.conf to Hyprland Lua config.
...
hl.on("hyprland.start", function()
    ...
    -- Modern replacement for lxqt-policykit-agent on your setup
...
-- Switch workspaces and move active window to workspaces
for i = 1, 10 do
